                        ...
                        <div className="absolute right-0 mt-2 w-72 sm:w-80 bg-slate-800/95 backdrop-blur-md border border-slate-700/50 rounded-lg shadow-xl z-50">
                            ...
                            <div className="max-h-64 overflow-y-auto">
                                {notifications.map((notification) => (
                                    <div key={notification.id} className={`p-3 border-b border-slate-700/30 hover:bg-slate-700/30 transition-colors relative ${!notification.read ? 'bg-blue-500/10' : ''}`}>
                                        <p className="text-slate-300 text-sm pr-6">{notification.message}</p>
                    ...
                    {showProfileDropdown && isLoggedIn && (
                        <div className="absolute right-0 mt-2 w-44 sm:w-48 bg-slate-800/95 backdrop-blur-md border border-slate-700/50 rounded-lg shadow-xl z-50">
                            <div className="p-3 border-b border-slate-700/50">
                                ...
                                <p className="text-slate-400 text-xs sm:text-sm">john.doe@example.com</p>
                            </div>
                            <div className="py-2">
