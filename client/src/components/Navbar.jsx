            ...
            <div className='flex items-center gap-3'>
                ...
                <div className="relative" ref={notificationDropdownRef}>
                    <button 
                        ...
                        className='relative p-2.5 cursor-pointer bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg transition-all duration-200 shadow-lg hover:shadow-slate-500/25 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-slate-500/50'
                        title="Notifications"
                    >
                        <svg className='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    ...
                    {showNotificationDropdown && (
                        <div className="absolute right-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-md border border-slate-700/50 rounded-lg shadow-xl z-50">
                            <div className="p-4 border-b border-slate-700/50">
                                <h3 className="text-white font-semibold">Notifications</h3>
                            </div>
                            <div className="max-h-64 overflow-y-auto">
                                {notifications.map((notification) => (
                                    <div key={notification.id} className={`p-3 border-b border-slate-700/30 hover:bg-slate-700/30 transition-colors ${!notification.read ? 'bg-blue-500/10' : ''}`}>
                ...
                <div className="relative" ref={profileDropdownRef}>
                    ...
                    {showProfileDropdown && (
                        <div className="absolute right-0 mt-2 w-48 bg-slate-800/95 backdrop-blur-md border border-slate-700/50 rounded-lg shadow-xl z-50">
                            ...
                            <div className="py-2">
                                <button className="w-full px-4 py-2 text-left text-slate-300 hover:bg-slate-700/50 hover:text-white transition-colors flex items-center gap-2">
                                    <svg className='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
